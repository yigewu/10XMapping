...
OUTPUT_DIR=$1;shift
SAMPLE=$1;shift
SCRIPT_DIR=/diskmnt/Projects/ccRCC_scratch/ccRCC_snRNA/Resources/snRNA_Processed_Data/10Xmapping/scripts/src
...
do
	perl ${SCRIPT_DIR}/refvar_heatmap_cell_with_chr.pl ${CELL_TYPE} ${SAMPLE}_map_ct_bc.txt ${MAF} ${SAMPLE}_mapping_heatmap_${CELL_TYPE}.txt
done
